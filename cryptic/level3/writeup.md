...
- /christopherjudge has the following contents:
  > [this](https://drive.google.com/file/d/1IgpRCk8jqJYtNxNwQHq21SzqxwOyZZdR/view?usp=sharing)
...
- The name of the image is a [youtube backlink](https://www.youtube.com/watch?v=NYtEKPEs0v8)
...
- The REG name of the plane is _B-5220_, which is the 3rd part. => **Part 3 of something is 5220**.
...
- A keen eye would also spot the pastebin tag _"O6241840"_, which is a date referring to **24th June 1840** which would be used later.

- The big potato stuff here is the [drive link](https://drive.google.com/file/d/1y4F8-8bf67T-h1xngOPvAlr3qCnq-uAt/view?usp=sharing) which has an image of an ISBN barcode.
- The barcode here stands irrelevant as it was a dummy image taken from wikipedia, but the ISBN part is important.
- Steg the image using Aperisolve or Incoherency to find out a maze puzzle. ![alt text](media/mez.png "Maze Image")

* Solving the maze reveals a nam **David Angers**, searching for the name reveals that he was a sculpturist.
* Use the date found, _24 June 1840_ with this name to get **Place Gutenberg**, **Gutenberg** holds importance.
* In the pastebin, there was also a _Discord User ID_ - 1071390063721721936
* Checking the server reveals that this is the User ID of the TS Bot in the server.
...
* The blender model has a text written inside it "find smth in here :tongue:", which is obvious, but actually exploring reveals a cube with the text **561 pt(2)** embossed into it.

* So we have got 561 as the part 2, and 5220 as the part 3, so the our number looks something like this: \_\_\_5615220.

* To find out the 1st part, you must open a ticket, and try to ping roles there, and you would find that there is this weird role called _1YHUZVdut9HSpYKKVSfy3Ql8rU5gkqVGk_ which is a [drive backlink](https://drive.google.com/drive/folders/1YHUZVdut9HSpYKKVSfy3Ql8rU5gkqVGk).
...
* So, we now know all the parts, combing all of them reveals **1025615220**.
...
* Use the format Page, Line, Word, and the first letter of the word to decode this. Upon searching the book reveals a link of **"Project Gutenberg"**, something similar to what we have seen before. Using that link we get the plaintext as _Shaun Usher_.
...
* Relating Nicholas Hoult with First Class reveals that he has played in the X-Men: First Class movie, and played the role of the **Beast**.
...
* Googling the image with the Sigma symbol in drive reveals the word **Enigma**, indicating that there is Enigma machine used somewhere. Also stegging the image reveals the ciphertext: `rymkc znmkb m`.
* Google the Marvel image reveals that it has an anomaly in it, where the Iron Spider man is being played by tobey maguire instead of tom holland. **The word "Iron" here is important.**
...
* The username of the reddit thread is _samuelito877_, => **877 is related here**
* So, its time to combine everything, search for an enigma machine, and change the reflector to tirpitz
  ![alt text](media/enigma.png "Enigma Image")
* Set the rotors to VIII, VII, VII.
...
* This google doc has nothing, until you get to the 37th page, where there's JSFuck ciphertext at a font size of 1pt.
...
* Counting the number of times this character occured, we get 500 occurences => 500 days of summer.
* From 500 days of summer, at the time stamp 09:50, as mentioned in the tab in long google doc, we get a reference of the smiths.
* Now the smiths here isn't the band, but the movie Mr. and Mrs. Smith => Brad Pitt.
* Enter Brad Pitt in the terminal.
* You get a [pastebin](https://pastebin.com/dwZy8G4e).
* This pastebin has the text
...
* And the raw paste data is filled with whitespace cipher.
...
* Google list of things that happened on 23rd May => International Day to End Obstetric Fistula => ans.
